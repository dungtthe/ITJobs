...
import { getJobPostsSummary } from "@/pages/admin/posts/job-post/services/getJobPostsSummary.js";
...
import { getCompanyNames } from "@/pages/admin/share-services/getCompanyNames";
...
export default function Index() {
  ...
  const handleAddPost = () => {
    navigate("/admin/job-post/add");
  };

  const handleViewPost = (id) => {
    navigate(`/admin/job-post/${id}`);
  };
            ...
            <table className="w-full border-collapse table-fixed">
              <thead>
                <tr className="bg-muted/40 border-b border-t">
                  ...
                  <th className="w-[8%] py-3.5 px-4 text-center font-medium text-xs uppercase tracking-wider text-foreground/70">
                    Thao tác
                  </th>
                </tr>
              </thead>
