...
using ITJobs.UseCases.Shared.Accounts.Queries.Login;
using MediatR;
...
namespace ITJobs.Infrastructure.APIs.Areas.Shared
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateImageAsync([FromBody] UseCases.Shared.Accounts.Commands.UpdateImageCommand command)
        {
